...
bottleneck_features = torch.load("../ssl_features_space/2025-04-19_17-25-19/bottleneck_features.pt", weights_only=True)

# Load the file names
with open("../ssl_features_space/2025-04-19_17-25-19/file_names.txt", "r") as f:
...
if target_image in file_names:
    ...
    feature = bottleneck_features[index]
...
def plot_individual_channels(feature, num_channels=4):
    ...
    plt.tight_layout()
    plt.savefig('../ssl_features_space/2025-04-19_17-25-19/individual_channels.png')
    plt.close()
...
def plot_pca_reduction(feature):
    ...
    plt.axis('off')
    plt.savefig('../ssl_features_space/2025-04-19_17-25-19/pca_visualization.png')
    plt.close()
...
def plot_feature_statistics(feature):
    ...
    plt.tight_layout()
    plt.savefig('../ssl_features_space/2025-04-19_17-25-19/feature_statistics.png')
    plt.close()
