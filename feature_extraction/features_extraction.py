...
PATH_TO_TRAINED_MODEL = '../ssl_trained_model/2025-04-19_01-19-21/Autoencoder.pt'
...
""" Saving Directory"""
FEATURE_SPACE_DIRECTORY = "../ssl_features_space"
...
def main():
    ...
    train_loader, _ = get_loaders_with_augmentation(
        ...
        config=config,
        shuffle_training=False,  # Important: Don't shuffle to maintain directory order
    )
    ...
    feature_file_path = os.path.join(features_space_path, "bottleneck_features.pt")
