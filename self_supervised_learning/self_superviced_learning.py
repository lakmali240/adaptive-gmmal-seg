...
from self_superviced_learning_utils import (
...
PATH_TO_TRAINED_MODEL = '../SSLModel/Results/pretrained_weights/2024-10-01_03-31-52/ISIC_Unsup.pt'

""" Load Dataset"""
TRAIN_IMG_DIR = "../../ISIC_2017_dataset/data/train_images/"
TRAIN_MASK_DIR = "../../ISIC_2017_dataset/data/train_masks/" # not used in self-supervised learning
VAL_IMG_DIR = "../../ISIC_2017_dataset/data/val_images/"
VAL_MASK_DIR = "../../ISIC_2017_dataset/data/val_masks/" # not used in self-supervised learning

""" Saving Directory"""
MODEL_DIRECTORY = "../ssl_trained_model"
IMAGE_DIRECTORY = "../ssl_validation_images"
...
def main():
    ...
    # Data loading
    train_loader, val_loader = load_and_review_data(
        train_transform, val_transforms, config
    )
...
def load_and_review_data(train_transform, val_transforms, config):
    """Load and review training and validation data"""
    train_loader, val_loader = get_loaders_with_augmentation(
        TRAIN_IMG_DIR,
        VAL_IMG_DIR,
        BATCH_SIZE,
        train_transform,
...
def handle_improved_model(model, optimizer, scheduler, epoch, valid_loss, best_loss, model_path):
    ...
    save_path = os.path.join(model_path, "Autoencoder.pt")
