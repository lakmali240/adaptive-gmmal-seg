...
""" Image Ranking """
IMAGE_RANKING_ASCENDING = True # True: Sort by rank in ascending order (high probablilty (low rank) values first); False: Sort by rank in desceding order (low probablilty (high rank) values first)
